...
def test_device_model_str(populated_test_db):
    ...
    expected_str_1 = (
        "Device(id=1, mqtt_id=111, name=Name 1, remote_name=Remote Name 1, online=True, device_type_id=1)\n"
    ...
    expected_str_2 = (
        "Device(id=2, mqtt_id=222, name=Name 2, remote_name=Remote Name 2, online=False, device_type_id=2)\n"
