...
def test_crud_get_device_type_by_name_returns_device_type(populated_test_db):
...
def test_crud_get_device_type_by_name_returns_none(empty_test_db):
    assert crud.get_device_type_by_name("Non-existent Device Type Name") is None


def test_crud_create_device_type_creates_a_new_device_type(empty_test_db):
    device_type = crud.create_device_type("Device Type Name")
    assert isinstance(device_type, models.DeviceType)
    assert device_type.name == "Device Type Name"


def test_crud_create_device_type_fails_on_duplicate_name(populated_test_db):
