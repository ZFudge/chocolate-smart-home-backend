...
def test_method_calls(test_database, crud_kwargs):
    get_device_type_by_name = Mock(wraps=crud.get_device_type_by_name)
    ...
    crud_kwargs['get_device_type_by_name'] = get_device_type_by_name
    ...
    get_device_type_by_name.assert_called_once_with("DEVICE_TYPE")
    ...
    assert get_device_type_by_name.call_count == 2
    ...
    assert get_device_type_by_name.call_count == 3
