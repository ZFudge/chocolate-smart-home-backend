...
def test_neo_pixel_model_str(populated_test_db):
    ...
    expected_str = (
        ...
        "Device(id=1, online=True, reboots=0, mqtt_id=123, remote_name=Test Neo Pixel Device - 1, name=Test Neo Pixel Device One, device_type_id=1, space_id=1)\n"
    ...
    expected_str = (
        ...
        "Device(id=2, online=True, reboots=0, mqtt_id=456, remote_name=Test Neo Pixel Device - 2, name=Test Neo Pixel Device Two, device_type_id=1, space_id=None)\n"
        "DeviceType(id=1, name=neo_pixel)\n"
        "Space=None"
    )
