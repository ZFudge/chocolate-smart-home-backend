...
def test_on_off_model_str(populated_test_db):
    ...
    expected_str = (
        ...
        "Device(id=1, mqtt_id=111, name=Test On Device, remote_name=Test On Device - 1, online=True, device_type_id=1)\n"
    ...
    expected_str = (
        ...
        "Device(id=2, mqtt_id=222, name=Test Off Device, remote_name=Test Off Device - 2, online=True, device_type_id=1)\n"
        "DeviceType(id=1, name=on_off)"
    )
