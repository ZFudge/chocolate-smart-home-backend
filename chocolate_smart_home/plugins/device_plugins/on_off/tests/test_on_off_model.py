...
def test_on_off_model_str(populated_test_db):
    ...
    expected_str = (
        ...
        "Device(id=1, mqtt_id=123, online=True, reboots=0, remote_name=Test On Device - 1, name=Test On Device, device_type_id=1, space_id=1)\n"
    ...
    expected_str = (
        ...
        "Device(id=2, mqtt_id=456, online=True, reboots=0, remote_name=Test Off Device - 2, name=Test Off Device, device_type_id=1, space_id=None)\n"
        "DeviceType(id=1, name=on_off)\n"
        "Space=None"
    )
