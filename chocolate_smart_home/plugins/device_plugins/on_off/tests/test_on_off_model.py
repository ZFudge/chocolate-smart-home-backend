...
def test_on_off_model_str(populated_test_db):
    ...
    expected_str = (
        ...
        "Device(id=1, remote_name=Test On Device - 1, online=True, reboots=0, client_id=1, device_name_id=1, device_type_id=1)\n"
    ...
    expected_str = (
        ...
        "Device(id=2, remote_name=Test Off Device - 2, online=True, reboots=0, client_id=2, device_name_id=2, device_type_id=1)\n"
